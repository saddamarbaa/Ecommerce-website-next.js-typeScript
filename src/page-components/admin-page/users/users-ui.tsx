          ...
          <div>
            ...
            <div className="mb-4 flex-wrap items-center justify-between gap-6 md:flex">
              ...
              <div className="mb-4 flex max-w-[85%]  gap-4 ">
                ...
                >
                  {totalDocs &&
                    Array.from(Array(totalDocs > 100 ? 100 : totalDocs).keys()).map(
                      (_day, index) => (
                    ...
                    <div>
                      <div className="mb-8 -mt-4 px-7">
                        ...
                        <div className="mt-2 flex gap-4">
                          <p className="min-w-[100px] truncate  text-gray-500"> First Name: </p>
                          <p className="text-gray-500  hover:text-[#c45500]">{user.firstName}</p>
                        </div>

                        <div className="mt-2 flex gap-4">
                          <p className="min-w-[100px] truncate  text-gray-500">Last Name: </p>
                        ...
                        {user.jobTitle && (
                          <div className="flex gap-4">
                            <p className="min-w-[100px] truncate  text-gray-500">
                              {' '}
                              {user.jobTitle}{' '}
                            </p>
                        ...
                        <div className="flex gap-4">
                          ...
                          <p className="0 text-gray-500 hover:text-[#c45500]">
                            {' '}
                            {user.dateOfBirth}
                          </p>
                        </div>
