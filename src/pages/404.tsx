...
function ErrorPage() {
  return (
    <div className="flex w-full flex-col items-center justify-center p-4 pb-[3rem] pt-[5rem] md:pt-[6rem]">
      <div className="max-w-md text-center">
        <h1 className="mb-4 text-6xl">404</h1>
        <div className="text-grey-900 mb-8 text-center">
          We re sorry. The page you requested could not be found. Please go back to the homepage or
          contact us
        </div>
