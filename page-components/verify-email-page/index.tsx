...
function VerfiyEmailPageComponent(props: any) {
  ...
  const {
    confirmEmailIsLoading, confirmEmailIsSuccess, confirmEmailIsError, confirmEmailIsMessage,
  } = props.authState
    ...
    <div className="flex items-center justify-center py-[3rem]  ">
      <div className=" mx-auto w-[90%]  md:max-w-[30rem] md:min-w-[20rem]">
        ...
        >
          ...
          {!props.userId && !props.token && !confirmEmailIsError && !confirmEmailIsSuccess && (
            <Alert
              variant="filled"
              severity="error"
            >
